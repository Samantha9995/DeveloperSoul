...
const questions = [
  QuizQuestion(
    'When you encounter a tricky bug, your first reaction is...?',
    {
      'Immediately ask AI! Stack Overflow is my savior!': 3,
      'Stare silently at the screen, trying to make it disappear with willpower.' : 2,
  ...
  QuizQuestion('Your coding style is...?', 
    {
      ...
      'Clean and elegant. Less is more. If you can\'t understand it, you\'re just a noob.': 2,
      'If it runs, it\'s good. Chaotic but orderly. Only I understand the art.': 1,
  ...
  QuizQuestion(
    'When you\'re working late at night, your source of inspiration is...?',
    {
      ...
      'Fantasizing about my vacation after this is done. That\'s what keeps me going.': 0,
    },
  ),
  QuizQuestion(
    'How do you view meetings?',
    {
      'Necessary communication, but can we please end it quickly? I want to go back to coding!': 3,
  ...
  QuizQuestion(
    'What\'s your attitude toward new technologies?',
    {
      ...
      'Learn a little, just enough to get by. Focus on solving real problems.': 1,
  ...
  QuizQuestion(
    'What\'s the state of your keyboard?',
    {
      ...
      'A few keycaps are missing, but it doesn\'t affect my lightning-fast coding.': 1,
